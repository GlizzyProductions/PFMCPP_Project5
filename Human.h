...
struct Human {
  ...
  struct HealthStatus {
    ...
    void contractSTD(const std::string whichSTD,
                     const std::string dateContracted) const;
    void developeHealthCondition(const bool &isHereditary,
                                 const std::string knownSymptoms,
